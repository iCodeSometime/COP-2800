 ...
 *
 *  This class contains all of the unit tests for project five.
 *  All public methods of the Car class are tested, then the user interface
 *  is loaded, and all of the buttons automatically pushed to test the limits.
 *****************************************************************************/
...
public class Project5Test extends Project5 {
   ...
   public void start(Stage primaryStage) {
      ...
      testGUIBrake();
      testGUIAccelerate();
      System.out.println(getCar().getSpeed());
...
class CarTest extends Car {
   ...
   public int accelerate() {
      ...
      fail(speed == SPEED_OF_LIGHT - SPEED_QUANTIZATION,
         "Looks like your code does weird stuff as it approaches c."
       + "Sounds like it could be a relatively serious error.");
      return getSpeed();
   }
   @Override
   public int brake() {
